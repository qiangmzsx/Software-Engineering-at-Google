...
|                   |               | chapter 18 :Build Systems and Build Philosophy    | [第十八章：构建系统，构建理念](./zh-cn/Chapter-18_Build_Systems_and_Build_Philosophy/Chapter-18_Build_Systems_and_Build_Philosophy.md) | 进行中      | @qiangmzsx                             |              | 构件（功能模块化，前提是接口标准化）；组件对数据和方法的简单封装。 |
